...
util.base64Encode = function(e) {
    ...
    (r = r || {}).cachetime = r.cachetime ? r.cachetime : 0;
                ...
                wx.login({
                    success: function(e) {
                        util.getWe7User(function(e) {
                            ...
                            }) : wx.canIUse("getUserInfo") ?  util.upadteUser(tcodek, function(e) {
                                "function" == typeof t && t(e);
                            })  : "function" == typeof t && t(e);
                        }, e.code);
                    },
    ...
    r.sessionid ? util.checkSession({
        ...
        fail: function() {
            r.sessionid = "", console.log("relogin"), wx.removeStorageSync("userInfo"), e();
        }
    }) : e();
